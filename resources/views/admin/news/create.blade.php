...
@section('content')
    ...
    <div class="w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        ...
        <form action="{{ route('admin.news.store') }}" class="p-8 space-y-6" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div id="paragraphs-container" class="space-y-4">
                ...
                <div class="relative paragraph-item">
                    <textarea rows="4" placeholder="Enter paragraph 1"
                        ...
                        name="paragraphs[]">{{ old('paragraphs.0') }}</textarea>
                </div>
            </div>
